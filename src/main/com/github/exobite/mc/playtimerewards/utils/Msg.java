...
public enum Msg {
    ...
    GUI_EDIT_REWARD_EXIT_SAVE_LORE("§aThis Option saves all changes\n§ayou've made and ends the editing.",
            ...
            false),
    GUI_EDIT_REWARD_FIELD_ITEM_NAME("§6Change %[0]§6.",
